...
mtv_migrate_migration_request: # <1>
  ...
  vms: # <12>
    - path: "/SDDC-Datacenter/vm/Workloads/sandbox-<GUID>/rhel9-vma-superlab-1" # <13>
...
<13> Path in VMware containing the Virtual Machine to migrate. Replace `<GUID>` with your assigned student GUID
