...
Select the your folder: {vcenter_vm_folder}, name the vm to *rhel9-vma-superlab-1* and click next.
...
IMPORTANT: Repeat this process more two times and name the vms as *rhel9-vma-superlab-2* and *rhel9-vma-superlab-3*.
